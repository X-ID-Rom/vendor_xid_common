...
ALARM_PATH := vendor/xid-common/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/xid-common/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/xid-common/prebuilt/common/media/audio/ringtones
